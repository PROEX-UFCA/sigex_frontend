                  ...
                  >
                    ...
                    <div className="flex flex-col relative z-10 lg:px-20 md:p-10 sm:p-8 p-8 w-full text-gray-50 mx-5 gap-2">
                      ...
                      <span className="flex text-left text-lg opacity-80">
                        ...
                        enim culpa irure. Exercitation nulla duis pariatur anim
                        ea nostrud eu dolore proident eiusmod. In sunt
                        reprehenderit irure do do. Voluptate velit exercitation
                        ea aute nisi. Culpa elit Lorem fugiat Lorem sunt
                        reprehenderit.
                      </span>
                      <TagsArea tags={item.tags} size="lg" />
                    </div>
                  </div>
                </CarouselItem>
              );
